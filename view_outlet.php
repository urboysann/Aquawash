...
<body>
    ...
    <center>
        ...
        <div class="table-container">
            <td>
                <a class="btn btn-primary" href="../outlet/tambah_outlet.php">
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th style="color: #3751fe;">Nama Outlet</th>
                        <th style="color: #3751fe;">Alamat</th>
                        <th style="color: #3751fe;">No Telephone</th>
                ...
                ?>
                    <tr>
                        ...
                        <td><?=$baris['tlp']?></td>
                        <td>
                            <a class="btn" href="../edit/edit_outlet.php?id=<?=$baris['id']?>">
                            <i class="fa-solid fa-pen-to-square fa-xl" style="color: #3751fe;"></i>
                            </svg>
                            </a>
                            <a class="btn" href="../delete/delete_outlet.php?id=<?=$baris['id']?>">
